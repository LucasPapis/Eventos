    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<UserUpdateDto> GetUserByUserNameAsync(string userName)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                throw new Exception($"Erro ao tentar encontar o username: {ex.Message}");
            }
        }
        ...
        public async Task<UserUpdateDto> UpdateAccount(UserUpdateDto userUpdateDto)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                throw new Exception($"Erro ao tentar ao atualizar o usuário: {ex.Message}");
            }
        }
        ...
        public async Task<bool> UserExist(string userName)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                throw new Exception($"Erro na verificação de usuário existente: {ex.Message}");
            }
        }
    }
}